...
<figure style="margin: 2rem 0;">
  <img src={`${import.meta.env.BASE_URL}diagrams/email-alias-flow.svg`} alt="Animation showing three email addresses (SHOP, BANK, NEWSLETTER) sending through a central SimpleLogin hub, which forwards everything to a single encrypted Proton vault" style="width: 100%; border-radius: 4px; display: block;" />
